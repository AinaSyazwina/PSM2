...
<head>
    ...
    <style>
        body {
            ...
            height: 100vh;
            padding-top: 80px; /* Increased gap from the top navigation */
        }
        .container {
            width: 90%;
            max-width: 800px;
        ...
        .icon {
            ...
            font-size: 50px;
            color: #007bff;
            margin-bottom: 5px; /* Adjust position above the heading */
        }
        h1 {
            text-align: center;
            margin-bottom: 10px;
        ...
        .success-message-overlay {
            ...
            width: 100%;
            height: 100%;
            background-color: rgba(0, 0, 0, 0.4); /* This ensures the overlay is the same as the modal */
        }
...
<body>
    <div class="container">
        ...
        <div class="quote-nav">
            <a href="SQuote.php" class="active">Create a Quote</a>
            <a href="SQuote3.php">Your Quotes</a>
            <a href="SQuote2.php">View All Quotes</a>
        </div>
