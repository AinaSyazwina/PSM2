...
<body>
    <div class="container">
        ...
        <div class="main-nav">
            ...
            <a href="LPQuote2.php" class="active">View All Quotes</a>
        </div>
        <div class="sub-nav">
            <a href="LPQuote2.php?sort=popular" class="<?= $sort == 'popular' ? 'active' : '' ?>">Popular</a>
            <a href="LPQuote2.php?sort=new" class="<?= $sort == 'new' ? 'active' : '' ?>">New</a>
        </div>
        <div class="quotes">
        ...
        <div class="pagination">
            <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                <a href="LPQuote2.php?page=<?= $i ?>&sort=<?= $sort ?>" class="<?= $page == $i ? 'active' : '' ?>"><?= $i ?></a>
            <?php endfor; ?>
        </div>
    </div>
</body>
