...
if ($sort === 'active' || $sort === 'inactive') {
    $conditions[] = "status = '" . mysqli_real_escape_string($conn, $sort) . "'";
} elseif ($sort === 'all') {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                                  <div class='action-icons'>
                                     ...
                                     <button class='delete-btn' onclick='togglePopup(\"" . $row['memberID'] . "\")'><ion-icon name='trash-outline'></ion-icon></button>
                                 </div>
                             </td>";
                        echo "</tr>";
                    }
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.sort-content a').forEach(link => {
