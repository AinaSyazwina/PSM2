...
function fetchNotifications($conn, $memberID) {
    ...
    // Fetch book notifications for the logged-in user
    $bookQuery = "SELECT 
                  'Book' as type, 
                  m.fullname, 
                  i.issueID as itemID, 
    ...
    // Fetch box notifications for the logged-in user
    ...
    // Fetch recently added book notifications
    ...
    // Fetch recently added box notifications
...
<header>
    <div class="brand-container">
        <a href="#" class="brand1">SKK</a>
    </div>
    <div class="navigation">
        <div class="navigation-items">
            <a href="HomeLib.php">Home</a>
            <a href="LPRegister.php">Register</a>
            <div class="dropdown">
                <a href="#" class="dropbtn">Manage Book <i class='bx bx-chevron-down'></i></a>
                <div class="dropdown-content">
                    <a href="LPIssuebook.php">Book Borrow</a>
                    <a href="LPReturnBook.php">Book Return</a>
                    <a href="LPBookAvail.php">Status Availability</a>
                </div>
            </div>
            <div class="dropdown">
                <a href="#" class="dropbtn">Manage Box <i class='bx bx-chevron-down'></i></a>
                <div class="dropdown-content">
                    <a href="LPIssueBox.php">Box Borrow</a>
                    <a href="LPReturnBox.php">Box Return</a>
                    <a href="LPBoxAvail.php">Status Availability</a>
                </div>
            </div>
            <div class="dropdown">
                <a href="#" class="dropbtn">Issue Record <i class='bx bx-chevron-down'></i></a>
                <div class="dropdown-content">
                    <a href="LPCheckIssue.php">Book</a>
                    <a href="LPCheckBox.php">Box</a>
                </div>
            </div>
            <div class="dropdown">
                <a href="#" class="dropbtn">Fine Records <i class='bx bx-chevron-down'></i></a>
                <div class="dropdown-content">
                    <a href="LPCheckFine.php">Book</a>
                    <a href="LPCheckFineBox.php">Box</a>
                </div>
            </div>
            <div class="dropdown">
                <a href="#" class="dropbtn">Review <i class='bx bx-chevron-down'></i></a>
                <div class="dropdown-content">
                    <a href="LPreview.php">Book</a>
                    <a href="LPBoxReview.php">Box</a>
                </div>
            </div>
            <a href="LPList.php">Book</a>
            <a href="LPListBox.php">Box</a>
    ...
    <div class="userinfo">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="LPProfile.php">My Profile</a>
                <a href="LPwishlist.php">Wishlist</a>
                <a href="LPQuote.php">Quotes</a>
                <a href="LPregulation.php">Regulations</a>
...
<script>
    ...
    // Hide flashcard after 5 seconds
    setTimeout(function() {
