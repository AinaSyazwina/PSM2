            ...
            if ($bookResult && $bookResult->num_rows > 0):
                ...
                while($row = $bookResult->fetch_assoc()): ?>
                    <div class='ranking-item'>
                        <a href="LPList1.php?bookAcquisition=<?php echo $row['book_acquisition']; ?>" class="ranking-link">
        ...
        <div class="rankings-boxes">
            ...
            if ($boxResult && $boxResult->num_rows > 0):
                ...
                while($row = $boxResult->fetch_assoc()): ?>
                    <div class='ranking-item'>
                        <a href="LPListBox1.php?BoxSerialNum=<?php echo $row['BoxSerialNum']; ?>" class="ranking-link">
                            <span class="ranking-number"><?php echo $rank; ?></span>
            ...
            <?php foreach ($recommendations as $book): ?>
                ...
                <?php if ($details): ?>
                    <div class='ranking-recommendation'>
                        <a href="LPList1.php?bookAcquisition=<?= htmlspecialchars($details['book_acquisition']) ?>" class="recommendation-link">
