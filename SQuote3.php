...
<div class="wishlist-container">
    ...
    <h1>My Quotes</h1>
    <p class="description">Edit your quotes to make them more memorable</p>

    <div class="quote-nav">
        <a href="SQuote.php">Create a Quote</a>
        <a href="SQuote3.php" class="active">Your Quotes</a>
...
<script>
    ...
    function showEditModal(id, quote, tags) {
        ...
        form.onsubmit = function(event) {
            ...
            const updatedQuote = document.getElementById('editQuote').value.trim();
            const updatedTags = document.getElementById('editTags').value.trim();
            
            if (!updatedQuote || !updatedTags) {
